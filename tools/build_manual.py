...
MANUAL_CSS = """
 ...
 #lightbox img { max-width:94%; max-height:94%; border:none; border-radius:6px; }
...
(function(){
  ...
  if(lb){ var lbimg=lb.querySelector('img');
    document.querySelectorAll('main img').forEach(function(im){
      ...
      im.addEventListener('click',function(){lbimg.src=im.src; lb.classList.add('show');});
    });
...
<div id="lightbox"><img alt="拡大画像"></div>
